...
export default function Home() {
    ...
    return (
        <main className='w-full min-h-screen bg-zinc-950  '>
            <div className='max-w-[870px] mx-auto px-4 pt-4 '>
                <Header />
                <div className='mt-10 '>
                    <div className='bg-zinc-900 hidden sm:flex rounded-lg p-8   gap-8'>
                        ...
                        <div className='flex flex-col'>
                            ...
                            <p className='text-zinc-400 mb-5 font-normal'>
                                Explore o mundo do desenvolvimento Front-end
                                através do meu blog, onde compartilho minha
                                paixão, motivação e o meu aprendizado.
                            </p>
